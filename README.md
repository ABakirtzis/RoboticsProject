...
Έπειτα από τροποποιήσεις που καναμε η τελική διαταξη είναι η παρακάτω: 
...
Μετά από πειραματικές μετρήσεις υπολογίστικαν τα παρακάτω στατιστικά μεγέθη:
...
Η αναπαράσταση του χώρου κίνησης αποτελείτε από ένα occupancy grid με ανάλυση 10Χ10 και μέγεθος κελίων 15cmX15cm.
...
Υπολογίζεται η γωνία που απαιτήτε να στρίψει το ρομπότ για να πλοηγηθεί στο επιλεγμένο κελί και αυτή ακολουθήτε με την χρήση ενώς PD ελεκτή που καθορίζει την γωνιακή ταχύτητα.

Τέλος όταν από της τίμες του estimation υπολογιστεί απόσταση από τον στόχο μικρότερη των 10cm τότε σταματάει το ρομπότ και ολοκληρώνεται το task.
