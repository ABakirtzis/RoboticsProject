...
4. Ο αλγόριθμος με των δυναμικών πεδίων έχει εγγενή προβλήματα αφού δημιουργεί τοπικά ελάχιστα που εξαρτώνται από την εκάστοτε τοπολογία με μη πρακτικό τρόπο αποφυγής τους εκ των προτέρων. Επίσης χρειάζονται γνώση του χώρου για τον υπολογισμό του πεδίου σε όλα τα σημεία ενδιαφέροντος.
Πρόταση: Προτείνται η χρήση του αλγορίθμου Α* για τον υπολογισμό μιας αρχικής διαδρομής. Λόγω του τρόπου με τον οποίο έχει υλοποιηθεί το φίλτρο Kalman, δεδομένου του ότι απορρίπτονται οι μετρήσεις των αισθητήρων απόστασης που αποκλείνουν πολύ από την αναμενόμενη τιμή τους μέσω της πρόβλεψης, μπορούν να χρησιμοποιηθούν αν είναι αρκετά μικρότερες από το αναμενόμενο για την ανίχνευση ενός έως τώρα αγνώστου εμποδίου. Σε εκείνη την στιγμή πρέπει να ξανατρέξει ο αλγόριθμος Α* για επαναυπολογισμό διαδρομής που θα αποφεύγει το συγκεκριμένο εμπόδιο. Σε περίπτωση που η διαδικασία είναι αργή, προτείνεται ο αλγόριθμος D* που έχει δημιουργηθεί ακριβώς γι αυτόν τον σκοπό, κρατώντας τα δεδομένα των προηγούμενων προσπαθειών για εύρεση διαδρομής και ενημερώνοντάς τα κατάλληλα.
